...
- (void) fetchProperty:(NXHeartbeatAPIResponse *)obligation {
    _isclockwiserotation = obligation.waterMarkContent.isClockwise;
    _fontName = obligation.waterMarkContent.fontName;
    _fontSize = obligation.waterMarkContent.fontSize;
    _transparency = obligation.waterMarkContent.transparentRatio;
    _textColor = [UIColor colorWithHexString:obligation.waterMarkContent.fontColor];
    
    _font = [UIFont fontWithName:@"Helvetica" size:[_fontSize floatValue]];
    _text = [self parserTextStr:obligation.waterMarkContent.text];
}
