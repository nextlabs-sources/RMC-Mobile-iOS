...
- (UILabel *)titleLab {
    if (!_titleLab) {
        _titleLab = [[UILabel alloc] initWithFrame:CGRectMake(15, _manager.dayViewGap+10, self.frame.size.width-30, _manager.dayViewHeight-10)];
        _titleLab.font = [UIFont systemFontOfSize:16];
        //_titleLab.backgroundColor = [UIColor redColor];
        _titleLab.textColor = [UIColor colorWithRed:176.0/255.0 green:176.0/255.0 blue:176.0/255.0 alpha:1.0];
    }
    return _titleLab;
}
