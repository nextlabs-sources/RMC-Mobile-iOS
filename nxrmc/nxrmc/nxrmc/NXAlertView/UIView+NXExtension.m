...
@implementation UIView (NXExtension)
...
- (instancetype)hd_addAnimationAtPoint:(CGPoint)point WithType:(NXAnimationType)type withColor:(UIColor *)animationColor completion:(void (^)(BOOL))completion {
