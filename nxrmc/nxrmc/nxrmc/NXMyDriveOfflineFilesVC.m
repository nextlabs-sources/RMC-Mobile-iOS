...
@interface NXMyDriveOfflineFilesVC ()<DetailViewControllerDelegate>
@property (nonatomic, strong) NSArray *searchArray;
@property (nonatomic, strong) NXRepositoryModel *myDriveModel;
@end

@implementation NXMyDriveOfflineFilesVC
- (NSArray *)searchArray {
    if (!_searchArray) {
...
- (void)updateData {
    ...
    NSArray<NXFileBase *> *data = [[NXLoginUser sharedInstance].myRepoSystem offlineFilesForRepository:self.myDriveModel];
