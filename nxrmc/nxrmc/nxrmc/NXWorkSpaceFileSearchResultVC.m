//
//  NXWorkSpaceFileSearchResultVC.m
//  nxrmc
//
...
#import "NXRMCDef.h"
@interface NXWorkSpaceFileSearchResultVC ()<UITableViewDelegate,UITableViewDataSource>
@property(nonatomic, weak) UITableView *tableView;
@property (nonatomic,weak) UIView *noSerchResultsTipsView;

@end

@implementation NXWorkSpaceFileSearchResultVC
...
- (void)commonInit {
    ...
    [tableView registerClass:[NXWorkSpaceItemCell class] forCellReuseIdentifier:@"cell"];
    tableView.tableFooterView = [[UIView alloc] init];
    tableView.tableHeaderView = [[UIView alloc] initWithFrame:CGRectMake(0, 0, 100,44)];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    /////////////////
    NXWorkSpaceItemCell *cell = [tableView dequeueReusableCellWithIdentifier:@"cell"];
